/*function login() {
    ...
    // Example of a simple check (replace with server-side authentication)
...
function register() {
    ...
    if (password !== confirmPassword) {
        ...
        // Example of a successful registration (replace with server-side logic)
...
function updatetotal(){
    ...
    //if price contents some cent values
